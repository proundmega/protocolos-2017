...
DOCKER_NOMBRE='proundmega/bind9-pachangamix'
...
echo "**********************************************************"
sleep 1s
echo "****** Builder de dns para dominio: pachangamix.com ******"
sleep 2s
...
cd $BIND_DIR
tar -czvf bind9-pachangamix.tar.gz *
...
cd ..
mv $BIND_DIR/bind9-pachangamix.tar.gz bind9-pachangamix.tar.gz
